...
$string['pluginname'] = 'Cephalometric Landmarks';
...
$string['pluginname_link'] = 'question/type/landmark';
$string['pluginnameadding'] = 'Adding cephalometric landmarks question';
$string['pluginnameediting'] = 'Editing cephalometric landmarks question';
$string['pluginnamesummary'] = 'Points are dragged and dropped onto a cephalogram.
...
// Added
$string['generate'] = 'Generate Points using ML';
$string['JSON'] = 'Upload JSON file';
$string['JSONFile'] = 'Points JSON File';

//Added
$string['distanceTitle'] = 'Distance';
$string['comparison'] = 'Comparison {$a}';
$string['addmoredistance'] = 'Add more Comparisons';
$string['distance'] = 'Distance';
//Aya
$string['angleTitle'] = 'Angles';
$string['anglecomparison'] = 'Angle {$a}';
$string['addmoreangle'] = 'Add more Angles';
$string['angle'] = 'Angle';

//Added
$string['userToken'] = 'token';
$string['userToken_help'] = 'You should put here the token provided by admins.If you lost it or forgot it contact admins for a new one';