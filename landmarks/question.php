...
/**
 * Question definition class for landmarks.
 *
 ...
 */
class qtype_landmarks_question extends qtype_ddtoimage_question_base
{

    public $showmisplaced;

    //checks if they have access
    public function check_file_access($qa, $options, $component, $filearea, $args, $forcedownload)
    {
        ...
        if ($component == 'qtype_landmarks' && $validfilearea) {
    ...
    public function is_complete_response(array $response)
    {
        foreach ($this->choices[1] as $choiceno => $notused) {
            if (
                isset($response[$this->choice($choiceno)])
    ...
    //aims to compare two sets of responses (represented by arrays) and determine whether they are identical
    ...
    public function get_validation_error(array $response)
    {
        ...
        return get_string('pleasedragatleastonemarker', 'qtype_landmarks');
    }
    ...
    public function grade_response(array $response)
    {
        ...
        // $fraction = ($right / $total) - qtype_landmarks_shape_circle::$penalty;
        $fraction = ($right-qtype_landmarks_shape_circle::$penalty)/ $total;
        if($fraction<0){
            $fraction=0;
        }
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_landmarks_drag_item
{
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_landmarks_drop_zone
{
    /** @var int Group of the item */
    public $group = 1;
    ...
    {
        $this->no = $no;
        $this->shape = qtype_landmarks_shape::create($shape, $coords);
        $this->coords = $coords;
    }
    ...
    public function summarise()
    {
        return get_string('summariseplaceno', 'qtype_landmarks', $this->no);
    }
...
//Aya
/**
 * Represents one of the angles 
 *
 * @copyright  2009 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_landmarks_angle_item
{
     ...
     * @param double 
     */
    public function __construct($point1, $point2, $point3, $angle)
    {
        $this->point1 = $point1;
        $this->point2 = $point2;
        $this->point3 = $point3;
...
/**
 * Represents one of the distances.
 *
 * @copyright  2009 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_landmarks_distance_item
{
    /** @var int */
    public $point1;
    /** @var int  */
     ...
     * @param double 
     */
    public function __construct($point1, $point2, $distance)
    {
        $this->point1 = $point1;
        $this->point2 = $point2;
