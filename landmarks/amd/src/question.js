...
define([
    ...
    function DragDropMarkersQuestion(containerId, readOnly, visibleDropZones) {
        ...
        this.questionAnswer = {};
        if (readOnly) {
            this.getRoot().addClass('qtype_landmarks-readonly');
        }
    ...
    DragDropMarkersQuestion.prototype.getNotYetLoadedImages = function() {
        return this.getRoot().find('.landmarks img.dropbackground').not(function(i, imgNode) {
    ...
    var questionManager = {
        ...
        init: function(containerId, readOnly, visibleDropZones) {
            ...
            if (!questionManager.markerEventHandlersInitialised.hasOwnProperty(containerId)) {
                ...
                if (questionContainer.classList.contains('landmarks') &&
                    !questionContainer.classList.contains('qtype_landmarks-readonly')) {
        ...
        getQuestionForEvent: function(e) {
            var containerId = $(e.currentTarget).closest('.que.landmarks').attr('id');
    ...
    /**
     * @alias module:qtype_landmarks/question
     */
    return {
        /**
