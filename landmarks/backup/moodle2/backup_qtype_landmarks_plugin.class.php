...
/**
 * Backup code for qtype_landmarks.
 *
...
/**
 * Provides the information to backup landmarks questions.
 *
 * @copyright 2011 The Open University
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class backup_qtype_landmarks_plugin extends backup_qtype_plugin {
    /**
     * Get the name of this question type.
     *
     * @return string the question type, like 'landmarks'.
     */
