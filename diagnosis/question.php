...
/**
 * Question definition class for diagnosis.
 *
 ...
 */
abstract class qtype_diagnosis_base extends question_graded_automatically {
    ...
    public function apply_attempt_state(question_attempt_step $step) {
        ...
        foreach ($this->order as $ansid) {
            ...
            $a = new stdClass();
            $a->id = 0;
            $a->answer = html_writer::span(get_string('deletedchoice', 'qtype_diagnosis'),
                    'notifyproblem');
    ...
    public function validate_can_regrade_with_other_version(question_definition $otherversion): ?string {
        ...
        if (count($this->answers) != count($otherversion->answers)) {
            return get_string('regradeissuenumchoiceschanged', 'qtype_diagnosis');
        }
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_diagnosis_single_question extends qtype_diagnosis_base {
    public function get_renderer(moodle_page $page) {
        return $page->get_renderer('qtype_diagnosis', 'single');
    }
    ...
    public function get_validation_error(array $response) {
        ...
        return get_string('pleaseselectananswer', 'qtype_diagnosis');
    }
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_diagnosis_multi_question extends qtype_diagnosis_base {
    public function get_renderer(moodle_page $page) {
        return $page->get_renderer('qtype_diagnosis', 'multi');
    }
    ...
    public function get_validation_error(array $response) {
        ...
        return get_string('pleaseselectatleastoneanswer', 'qtype_diagnosis');
    }
